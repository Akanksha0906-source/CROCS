...
triggers {
  pollSCM '* * * * *'
    ...
    stages {
        ...
        stage('Notification'){
            steps{
                slackSend baseUrl: 'https://hooks.slack.com/services/', channel: '#crocs', color: 'good', message: 'welcome to jenkins slack world', teamDomain: 'aashu', tokenCredentialId: 'slacknotifier'
            }
        }
    }
}
